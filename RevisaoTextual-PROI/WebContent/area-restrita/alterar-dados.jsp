	...
	<div class="container">
		...
		<div class="form">
			<form action="usuario" method="post">
				...
				<div class="form-row">
					<input type="number" name="id" value="${userSession.getId()}"
						style="display: none;">

					<div class="form-group col-md-6">
						<label>Nome</label> <input type="text" name="nome"
							class="form-control" value="${userSession.getNome()}"
							placeholder="Digite seu nome" required="required">
					</div>

					<div class="form-group col-md-6">
						<label>Email</label> <input type="email" class="form-control"
							name="email" value="${userSession.getEmail()}"
				...
				<div class="form-row">
					<div class="form-group col-md-4">
						<label>CPF</label> <input type="text" class="form-control"
							name="cpf" value="${userSession.getCpf()}"
					...
					<div class="form-group col-md-4">
						<label>Confirme sua senha</label> <input type="password"
							class="form-control" name="confirmacao-senha"
							placeholder="************">
					</div>
				</div>
